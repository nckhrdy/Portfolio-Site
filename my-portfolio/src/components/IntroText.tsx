  ...
  return (
    <>
      ...
      <div className='col-start-1 col-end-5 row-start-5 row-end-5 flex flex-col justify-center ml-20'>
        <p className="text-3xl md:text-4xl" style={{ fontVariationSettings: "'wdth' 110, 'wght' 700" }}>
          Engineer | Creator | Thinker | Doer
        </p>
        <p className="text-3xl md:text-4xl mt-4" style={{ fontVariationSettings: "'wdth' 110, 'wght' 700" }}>
