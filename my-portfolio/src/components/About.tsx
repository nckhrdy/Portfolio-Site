  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <main className="grid grid-cols-6 grid-rows-6 h-screen" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div className="col-start-1 col-end-3 row-start-2 row-end-6 flex justify-center ml-20">
          <img src="/assets/aboutme.svg" alt="Email Me!" />
        </div>
        <div className="col-start-3 col-end-7 row-start-2 row-end-6 flex justify-center items-center mt-10 mr-20">
          <div className="bg-white bg-opacity-90 shadow-lg p-4 md:p-6 max-w-3xl w-full rounded-lg" style={{ margin: "0 10%" }}>
            <p className="text-lg md:text-2xl lg:text-3xl font-normal" style={{ fontFamily: "'Nunito', serif", color: "#000000", lineHeight: "1.6" }}>
              {"I'm a senior studying Computer Engineering at Boston University and my biggest passion is innovation. My interests began with robotics from an early age and that has since evolved into a love for software development and entrepreneurship. Recently, most of my projects have been built using emebedded systems which has allowed me to quickly turn ideas to prototypes and then to practical solutions. I'm excited to see where my journey takes me as I aim to bridge the gaps between technology and business solutions."}
            </p>
          </div>
        </div>
      </main>
